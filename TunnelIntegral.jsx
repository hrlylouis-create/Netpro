...
const TAUX_PLEIN = 34.90
const TAUX_APRES = 17.45
const TOTAL_STEPS = 7
...
export default function TunnelIntegral() {
  ...
  function toggleCreneau(h) {
    ...
    if (existingStart === h) {
      setCreneaux(prev => prev.filter(s => s !== existingStart))
      return
    }
    if (existingStart) {
      setCreneaux(prev => [...prev.filter(s => s !== existingStart), h])
      return
    }
  ...
  const avanceDiscount = avanceImmediate ? (prixSession + surchargeOptions) * 0.5 : 0
  const total = duree ? prixSession + surchargeOptions - avanceDiscount : null
        ...
        return (
          <>
            ...
            <div className="smr-option-popup">
              ...
              {canAdd && (
                <CTAButton color="orange" fullWidth onClick={() => { setDuree(newDuree); goNext() }}>
                  Ajouter {extraLabel}
                </CTAButton>
              )}
    ...
    <div className="smr-page smr-page--integral">
      ...
      <div className="smr-nav">
        <div className="smr-nav-inner">
          ...
          {step < 8 && (
            <CTAButton color="orange" onClick={goNext} disabled={!canNext}>SUIVANT</CTAButton>
          )}
          {step > 1 && (
            ...
            <div className="smr-mini-ticket-row">
              <div className="smr-mini-ticket-left">
                ...
                <span className="smr-mini-ticket-detail">
                  {duree && selectedDate ? `${dureeLabel} · ${dateText}` : 'Intégral'}
                </span>
              </div>
          ...
          <div className="smr-ticket-wrapper">
            <div className="smr-ticket">
              ...
              <div className="smr-ticket-body">
                ...
                <p className="smr-ticket-subtitle">Réservation Intégral</p>
                ...
                <CTAButton color="orange" onClick={async () => {
